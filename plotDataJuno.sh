...
gmt plot data/GalileoData/G1_BX.txt -JX? -R${dates}/${xlims} -Bya${xstep} -By+l"B@-x@- [nT]" -Bpxa5M -Bx+l"1996 Jun 27" -W${thick},${coldat} #-B+t"G1"
...
gmt subplot set 1,0
gmt plot data/GalileoData/G1_BY.txt -JX? -R${dates}/${ylims} -Bya${ystep} -By+l"B@-y@- [nT]" -Bpxa5M -Bx+l"1996 Jun 27" -W${thick},${coldat}
...
gmt subplot set 2,0
gmt plot data/GalileoData/G1_BZ.txt -JX? -R${dates}/${zlims} -Bya${zstep} -By+l"B@-z@- [nT]" -Bpxa5M -Bx+l"1996 Jun 27" -W${thick},${coldat}
...
gmt plot data/GalileoData/G2_BX.txt -JX? -R${dates}/${xlims} -Bya${xstep} -By+l"Bx [nT]" -Bpxa5M -Bx+l"1996 Sep 6" -W${thick},${coldat} #-B+t"G2"
...
gmt subplot set 1,1
gmt plot data/GalileoData/G2_BY.txt -JX? -R${dates}/${ylims} -Bya${ystep} -By+l"By [nT]" -Bpxa5M -Bx+l"1996 Sep 6" -W${thick},${coldat}
...
gmt subplot set 2,1
gmt plot data/GalileoData/G2_BZ.txt -JX? -R${dates}/${zlims} -Bya${zstep} -By+l"Bz [nT]" -Bpxa5M -Bx+l"1996 Sep 6" -W${thick},${coldat}
...
gmt plot data/GalileoData/G28_BX.txt -JX? -R${dates}/${xlims} -Bya${xstep} -By+l"Bx [nT]" -Bpxa2M -Bx+l"2000 May 20" -W${thick},${coldat} #-B+t"G28"
...
gmt subplot set 1,2
gmt plot data/GalileoData/G28_BY.txt -JX? -R${dates}/${ylims} -Bya${ystep} -By+l"By [nT]" -Bpxa2M -Bx+l"2000 May 20" -W${thick},${coldat}
...
gmt subplot set 2,2
gmt plot data/GalileoData/G28_BZ.txt -JX? -R${dates}/${zlims} -Bya${zstep} -By+l"Bz [nT]" -Bpxa2M -Bx+l"2000 May 20" -W${thick},${coldat}
...
gmt plot data/JunoData/J1_BX.txt -JX? -R${dates}/${xlims} -Bya${xstep} -By+l"Bx [nT]" -Bpxa5M -Bx+l"2021 Jun 7" -W${thick},${coldat} #-B+t"J"
...
gmt subplot set 1,3
gmt plot data/JunoData/J1_BY.txt -JX? -R${dates}/${ylims} -Bya${ystep} -By+l"By [nT]" -Bpxa5M -Bx+l"2021 Jun 7" -W${thick},${coldat}
...
gmt plot data/JunoData/J1_BZ.txt -Bya${zstep} -By+l"Bz [nT]"  -JX?  -R${dates}/${zlims}  -BpxcJtimelabels.txt -Bx+l"2021 Jun 7" -W${thick},${coldat}
