...
dates=2021-06-07T16:54:01/2021-06-07T16:58:00
tstep=2

gmt subplot set 0,3
gmt plot data/JunoData/J1_BX.txt -JX? -R${dates}/${xlims} -Bya${xstep} -By+l"Bx [nT]" -Bpxa${tstep}M -Bx+l"June 07, 2021" -W${thick} -B+t"J1"
gmt plot data/${1}/G101_BX_sim.txt -W${thick2},${col},$type
rmsX=$(gmt math data/JunoData/J1_BX.txt data/${1}/G101_BX_sim.txt NEG ADD RMS -S 10 MUL RINT 10 DIV -o1 =)
gmt text <<EOF
2021-06-07T16:56:00 -60 rms = ${rmsX} nT
EOF

gmt subplot set 1,3
gmt plot data/JunoData/J1_BY.txt -JX? -R${dates}/${ylims} -Bya${ystep} -By+l"By [nT]" -Bpxa${tstep}M -Bx+l"June 07, 2021" -W${thick}
gmt plot data/${1}/G101_BY_sim.txt -W${thick2},${col},$type
rmsY=$(gmt math data/JunoData/J1_BY.txt data/${1}/G101_BY_sim.txt NEG ADD RMS -S 10 MUL RINT 10 DIV -o1 =)
gmt text <<EOF
2021-06-07T16:56:00 430 rms = ${rmsY} nT
EOF

gmt subplot set 2,3
gmt plot data/JunoData/J1_BZ.txt -JX? -R${dates}/${zlims} -Bya${zstep} -By+l"Bz [nT]" -Bpxa${tstep}M -Bx+l"June 07, 2021" -W${thick}
gmt plot data/${1}/G101_BZ_sim.txt -W${thick2},${col},$type
rmsZ=$(gmt math data/JunoData/J1_BZ.txt data/${1}/G101_BZ_sim.txt NEG ADD RMS -S 10 MUL RINT 10 DIV -o1 =)
gmt text <<EOF
2021-06-07T16:56:00 -900 rms = ${rmsZ} nT
EOF
